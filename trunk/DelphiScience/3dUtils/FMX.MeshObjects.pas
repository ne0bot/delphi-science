...
function TAnnulus.ExtendPointToPlane(point: TPoint3d; Plane,
...
procedure TAnnulus.GetAnnulusPOintsForPosY(PosY: Single; var IPoints,
  OPoints: TPointArray);
var
  I: Integer;
begin
...
procedure TPipe.BuildCylinder(Points:TPointArray; Back:Boolean; var SectionPoints,FirstPoints,LastPoints:TPointArray);
var FData:TMeshData;
    i,h,k: Integer;
...
procedure TPipe.GetAnnulusPointsForPosY(PosY: Single; var IPoints,
  OPoints: TPointArray);
var
  I: Integer;
begin
